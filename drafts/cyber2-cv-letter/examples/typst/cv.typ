// Hand-authored Typst source for Sarah Connor's CV — default theme.
// Uses the exact same markup convention as the Markdown examples (mvp
// spec §5), just written directly in Typst instead of run through Pandoc.
...
- Built an automated prompt-injection fuzzing harness that surfaced 40+
  ...
  release.
  #quote[Custom mutation engine over a 12k-seed corpus, wired into the
...
- Led adversarial robustness reviews for a fraud-detection model serving
  ...
  under 2%.
  #quote[Combined gradient-based attack simulation with a red-team-authored
...
_Omni Consumer Security | Detroit, MI_
...
_University of Texas at Austin | Austin, TX_

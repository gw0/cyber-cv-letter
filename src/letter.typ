...
#import "theme.typ": fg, resolve-font, resolve-accent, page-geometry, space-header-to-section, space-letter-paragraph, mark-gutter
...
#let letter(
  ...
  block(above: space-header-to-section, below: paragraph-spacing, breakable: false, {
    ...
    set text(..resolve-font(font-chrome, weight: "regular"), size: 9pt, fill: accent-list.at(0))
    date
  })
